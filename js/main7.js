...
back_div.addEventListener("click", function(e) {
    ...
    if(back_div.style.display == 'inline') {
        ...
        if(div2.hasChildNodes()){
            ...
            console.log("Remove children from div2 in back_div listener");
        }   
    }
}, false);
...
function test_layout(e) {
   ...
   // e.stopPropagation();
    ...
    if(div.hasChildNodes()){
        ...
        console.log("Remove children from div in test_layout function");
    }
    ...
    if(div3.hasChildNodes()){
        ...
        console.log("Remove children from div3 in test_layout function");
    } 
    ...
    switch(e.target.id) {
        case "genesis": 
            ...
            for(i = 0; i < genesis_full_data.length; i++) {
                let t = verse_parser5(genesis_full_data[i], genesis_first_data[i], genesis_blank_data[i], genesis_misc_data[i], e.target.textContent, i, chapter);
        ...
        case "exodus":
            for(i = 0; i < exodus_full_data.length; i++) {
                let t = verse_parser5(exodus_full_data[i], exodus_first_data[i], exodus_blank_data[i], exodus_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
        ...
        case "leviticus":
            for(i = 0; i < leviticus_full_data.length; i++) {
                let t = verse_parser5(leviticus_full_data[i], leviticus_first_data[i], leviticus_blank_data[i], leviticus_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
        ...
        case "numbers":
            for(i = 0; i < numbers_full_data.length; i++) {
                let t = verse_parser5(numbers_full_data[i], numbers_first_data[i], numbers_blank_data[i], numbers_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
        ...
        case "deuteronomy":
            for(i = 0; i < deuteronomy_full_data.length; i++) {
                let t = verse_parser5(deuteronomy_full_data[i], deuteronomy_first_data[i], deuteronomy_blank_data[i], deuteronomy_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
        ...
        case "joshua":
            for(i = 0; i < joshua_full_data.length; i++) {
                let t = verse_parser5(joshua_full_data[i], joshua_first_data[i], joshua_blank_data[i], joshua_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
        ...
        case "judges":
            for(i = 0; i < judges_full_data.length; i++) {
                let t = verse_parser5(judges_full_data[i], judges_first_data[i], judges_blank_data[i], judges_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
        ...
        case "ruth":
            for(i = 0; i < ruth_full_data.length; i++) {
                let t = verse_parser5(ruth_full_data[i], ruth_first_data[i], ruth_blank_data[i], ruth_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
        ...
        case "samuel1":
            for(i = 0; i < samuel1_full_data.length; i++) {
                let t = verse_parser5(samuel1_full_data[i], samuel1_first_data[i], samuel1_blank_data[i], samuel1_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                //"chapter" holds chapter number of current verse for next cycle for comparison
                // to see if next verse is in current chapter or in the next chapter
                chapter = t[1];
        ...
        case "samuel2":
            for(i = 0; i < samuel2_full_data.length; i++) {
                let t = verse_parser5(samuel2_full_data[i], samuel2_first_data[i], samuel2_blank_data[i], samuel2_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
        ...
        case "kings1":
            for(i = 0; i < kings1_full_data.length; i++) {
                let t = verse_parser5(kings1_full_data[i], kings1_first_data[i], kings1_blank_data[i], kings1_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
        ...
        case "kings2":
            for(i = 0; i < kings2_full_data.length; i++) {
                let t = verse_parser5(kings2_full_data[i], kings2_first_data[i], kings2_blank_data[i], kings2_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
        ...
        case "chronicles1":
            for(i = 0; i < chronicles1_full_data.length; i++) {
                let t = verse_parser5(chronicles1_full_data[i], chronicles1_first_data[i], chronicles1_blank_data[i], chronicles1_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
        ...
        case "chronicles2":
            for(i = 0; i < chronicles2_full_data.length; i++) {
                let t = verse_parser5(chronicles2_full_data[i], chronicles2_first_data[i], chronicles2_blank_data[i], chronicles2_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
        ...
        case "ezra":
            for(i = 0; i < ezra_full_data.length; i++) {
                let t = verse_parser5(ezra_full_data[i], ezra_first_data[i], ezra_blank_data[i], ezra_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
        ...
        case "nehemiah":
            for(i = 0; i < nehemiah_full_data.length; i++) {
                let t = verse_parser5(nehemiah_full_data[i], nehemiah_first_data[i], nehemiah_blank_data[i], nehemiah_misc_data[i], e.target.textContent, i, chapter);
                // console.log(t);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
        ...
        case "esther":
            for(i = 0; i < esther_full_data.length; i++) {
                let t = verse_parser5(esther_full_data[i], esther_first_data[i], esther_blank_data[i], esther_misc_data[i], e.target.textContent, i, chapter);
                // console.log(t);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
        ...
        case "job":
            for(i = 0; i < job_full_data.length; i++) {
                let t = verse_parser5(job_full_data[i], job_first_data[i], job_blank_data[i], job_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
        ...
        case "psalms":
            for(i = 0; i < psalms_full_data.length; i++) {
                let t = verse_parser5(psalms_full_data[i], psalms_first_data[i], psalms_blank_data[i], psalms_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
        ...
        case "proverbs":
            for(i = 0; i < proverbs_full_data.length; i++) {
                let t = verse_parser5(proverbs_full_data[i], proverbs_first_data[i], proverbs_blank_data[i], proverbs_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
        ...
        case "ecclesiastes":
            for(i = 0; i < ecclesiastes_full_data.length; i++) {
                let t = verse_parser5(ecclesiastes_full_data[i], ecclesiastes_first_data[i], ecclesiastes_blank_data[i], ecclesiastes_misc_data[i], e.target.textContent, i, chapter);
        ...
        case "solomon":
            for(i = 0; i < solomon_full_data.length; i++) {
                let t = verse_parser5(solomon_full_data[i], solomon_first_data[i], solomon_blank_data[i], solomon_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
        ...
        case "isaiah":
            for(i = 0; i < isaiah_full_data.length; i++) {
                let t = verse_parser5(isaiah_full_data[i], isaiah_first_data[i], isaiah_blank_data[i], isaiah_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
        ...
        case "jeremiah":
            for(i = 0; i < jeremiah_full_data.length; i++) {
                let t = verse_parser5(jeremiah_full_data[i], jeremiah_first_data[i], jeremiah_blank_data[i], jeremiah_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
        ...
        case "lamentations":
            for(i = 0; i < lamentations_full_data.length; i++) {
                let t = verse_parser5(lamentations_full_data[i], lamentations_first_data[i], lamentations_blank_data[i], lamentations_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "ezekiel":
            for(i = 0; i < ezekiel_full_data.length; i++) {
                let t = verse_parser5(ezekiel_full_data[i], ezekiel_first_data[i], ezekiel_blank_data[i], ezekiel_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "daniel":
            for(i = 0; i < daniel_full_data.length; i++) {
                let t = verse_parser5(daniel_full_data[i], daniel_first_data[i], daniel_blank_data[i], daniel_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }         
            break;
        ...
        case "hosea":
            for(i = 0; i < hosea_full_data.length; i++) {
                let t = verse_parser5(hosea_full_data[i], hosea_first_data[i], hosea_blank_data[i], hosea_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "joel":
            for(i = 0; i < joel_full_data.length; i++) {
                let t = verse_parser5(joel_full_data[i], joel_first_data[i], joel_blank_data[i], joel_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "amos":
            for(i = 0; i < amos_full_data.length; i++) {
                let t = verse_parser5(amos_full_data[i], amos_first_data[i], amos_blank_data[i], amos_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "obadiah":
            for(i = 0; i < obadiah_full_data.length; i++) {
                let t = verse_parser5(obadiah_full_data[i], obadiah_first_data[i], obadiah_blank_data[i], obadiah_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "jonah":
            for(i = 0; i < jonah_full_data.length; i++) {
                let t = verse_parser5(jonah_full_data[i], jonah_first_data[i], jonah_blank_data[i], jonah_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "micah":
            for(i = 0; i < micah_full_data.length; i++) {
                let t = verse_parser5(micah_full_data[i], micah_first_data[i], micah_blank_data[i], micah_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "nahum":
            for(i = 0; i < nahum_full_data.length; i++) {
                let t = verse_parser5(nahum_full_data[i], nahum_first_data[i], nahum_blank_data[i], nahum_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "habakkuk":
            for(i = 0; i < habakkuk_full_data.length; i++) {
                let t = verse_parser5(habakkuk_full_data[i], habakkuk_first_data[i], habakkuk_blank_data[i], habakkuk_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "zephaniah":
            for(i = 0; i < zephaniah_full_data.length; i++) {
                let t = verse_parser5(zephaniah_full_data[i], zephaniah_first_data[i], zephaniah_blank_data[i], zephaniah_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "haggai":
            for(i = 0; i < haggai_full_data.length; i++) {
                let t = verse_parser5(haggai_full_data[i], haggai_first_data[i], haggai_blank_data[i], haggai_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "zechariah":
            for(i = 0; i < zechariah_full_data.length; i++) {
                let t = verse_parser5(zechariah_full_data[i], zechariah_first_data[i], zechariah_blank_data[i], zechariah_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "malachi":
            for(i = 0; i < malachi_full_data.length; i++) {
                let t = verse_parser5(malachi_full_data[i], malachi_first_data[i], malachi_blank_data[i], malachi_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "matthew":
            for(i = 0; i < matthew_full_data.length; i++) {
                let t = verse_parser5(matthew_full_data[i], matthew_first_data[i], matthew_blank_data[i], matthew_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "mark":
            for(i = 0; i < mark_full_data.length; i++) {
                let t = verse_parser5(mark_full_data[i], mark_first_data[i], mark_blank_data[i], mark_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "luke":
            for(i = 0; i < luke_full_data.length; i++) {
                let t = verse_parser5(luke_full_data[i], luke_first_data[i], luke_blank_data[i], luke_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "john":
            for(i = 0; i < john_full_data.length; i++) {
                let t = verse_parser5(john_full_data[i], john_first_data[i], john_blank_data[i], john_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "acts":
            for(i = 0; i < acts_full_data.length; i++) {
                let t = verse_parser5(acts_full_data[i], acts_first_data[i], acts_blank_data[i], acts_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "romans":
            for(i = 0; i < romans_full_data.length; i++) {
                let t = verse_parser5(romans_full_data[i], romans_first_data[i], romans_blank_data[i], romans_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "corinthians1":
            for(i = 0; i < corinthians1_full_data.length; i++) {
                let t = verse_parser5(corinthians1_full_data[i], corinthians1_first_data[i], corinthians1_blank_data[i], corinthians1_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "corinthians2":
            for(i = 0; i < corinthians2_full_data.length; i++) {
                let t = verse_parser5(corinthians2_full_data[i], corinthians2_first_data[i], corinthians2_blank_data[i], corinthians2_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "galatians":
            for(i = 0; i < galatians_full_data.length; i++) {
                let t = verse_parser5(galatians_full_data[i], galatians_first_data[i], galatians_blank_data[i], galatians_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "ephesians":
            for(i = 0; i < ephesians_full_data.length; i++) {
                let t = verse_parser5(ephesians_full_data[i], ephesians_first_data[i], ephesians_blank_data[i], ephesians_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
        ...
        case "philippians":
            for(i = 0; i < philippians_full_data.length; i++) {
                let t = verse_parser5(philippians_full_data[i], philippians_first_data[i], philippians_blank_data[i], philippians_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
        ...
        case "colossians":
            for(i = 0; i < colossians_full_data.length; i++) {
                let t = verse_parser5(colossians_full_data[i], colossians_first_data[i], colossians_blank_data[i], colossians_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "thessalonians1":
            for(i = 0; i < thessalonians1_full_data.length; i++) {
                let t = verse_parser5(thessalonians1_full_data[i], thessalonians1_first_data[i], thessalonians1_blank_data[i], thessalonians1_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "thessalonians2":
            for(i = 0; i < thessalonians2_full_data.length; i++) {
                let t = verse_parser5(thessalonians2_full_data[i], thessalonians2_first_data[i], thessalonians2_blank_data[i], thessalonians2_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "timothy1":
            for(i = 0; i < timothy1_full_data.length; i++) {
                let t = verse_parser5(timothy1_full_data[i], timothy1_first_data[i], timothy1_blank_data[i], timothy1_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "timothy2":
            for(i = 0; i < timothy2_full_data.length; i++) {
                let t = verse_parser5(timothy2_full_data[i], timothy2_first_data[i], timothy2_blank_data[i], timothy2_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "titus":
            for(i = 0; i < titus_full_data.length; i++) {
                let t = verse_parser5(titus_full_data[i], titus_first_data[i], titus_blank_data[i], titus_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "philemon":
            for(i = 0; i < philemon_full_data.length; i++) {
                let t = verse_parser5(philemon_full_data[i], philemon_first_data[i], philemon_blank_data[i], philemon_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "hebrews":
            for(i = 0; i < hebrews_full_data.length; i++) {
                let t = verse_parser5(hebrews_full_data[i], hebrews_first_data[i], hebrews_blank_data[i], hebrews_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "james":
            for(i = 0; i < james_full_data.length; i++) {
                let t = verse_parser5(james_full_data[i], james_first_data[i], james_blank_data[i], james_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "peter1":
            for(i = 0; i < peter1_full_data.length; i++) {
                let t = verse_parser5(peter1_full_data[i], peter1_first_data[i], peter1_blank_data[i], peter1_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "peter2":
            for(i = 0; i < peter2_full_data.length; i++) {
                let t = verse_parser5(peter2_full_data[i], peter2_first_data[i], peter2_blank_data[i], peter2_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "john1":
            for(i = 0; i < john1_full_data.length; i++) {
                let t = verse_parser5(john1_full_data[i], john1_first_data[i], john1_blank_data[i], john1_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "john2":
            for(i = 0; i < john2_full_data.length; i++) {
                let t = verse_parser5(john2_full_data[i], john2_first_data[i], john2_blank_data[i], john2_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "john3":
            for(i = 0; i < john3_full_data.length; i++) {
                let t = verse_parser5(john3_full_data[i], john3_first_data[i], john3_blank_data[i], john3_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            break;
        ...
        case "jude":
            for(i = 0; i < jude_full_data.length; i++) {
                let t = verse_parser5(jude_full_data[i], jude_first_data[i], jude_blank_data[i], jude_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
            console.log('Jude');
        ...
        case "revelation":
            ...
            for(i = 0; i < revelation_full_data.length; i++) {
                let t = verse_parser5(revelation_full_data[i], revelation_first_data[i], revelation_blank_data[i], revelation_misc_data[i], e.target.textContent, i, chapter);
                document.getElementById('full_content').insertAdjacentHTML('beforeend', t[0]);
                chapter = t[1];
            }
    ...
    for (let el of document.querySelectorAll('.misc_verse_div')) el.style.display = 'none';
...
function toggleVerse(e) {
    ...
    if(e.target.tagName == 'H3') {
        ...
        let t4 = "<p class='misc_modal_content'>" + child_list[4].textContent + "</p>";
        

        let ticker = 30; // To hold value in seconds of the length for each of the 3 transitions (full, 1st letter, blank)
        let ticker2 = 2000; // Approximate time before cycling stops in seconds    1400  
        let time_elapsed = 0;
        let cycle_count = 1;

        
        let t = verse_parser6(t1, t2, t3, t4, t0, 'verse-mode');
        ...
        if(grandparent2 && grandparent2.tagName == "DIV") {
            ...
            t4 = "<p class='misc_modal_content'>" + child_list2[4].textContent + "</p>";
            t = verse_parser6(t1, t2, t3, t4, t0, 'verse-mode');
            document.getElementById('version_mode_content').insertAdjacentHTML('beforeend', t);
            //console.log(child_list[1]);
            //console.log(child_list2[2]);
        ...
        if(grandparent3 && grandparent3.tagName == "DIV") {
            ...
            t4 = "<p class='misc_modal_content'>" + child_list3[4].textContent + "</p>";

            t = verse_parser6(t1, t2, t3, t4, t0, 'verse-mode');
            document.getElementById('version_mode_content').insertAdjacentHTML('beforeend', t);
        }

        let checker = 1; // Switch variable to show full, 1st letter or blank or misc filler word verse mode. Starts full
        ...
        let el4 = document.getElementsByClassName('misc_modal_content');
            ...
            if(ticker <= 0) {
                switch(checker) {
                    ...
                    case 4:
                        ...
                        console.log('case 4: full misc');
                        verse_hider(el1, 'inline');
                        verse_hider(el2, 'none');
                        verse_hider(el3, 'none');
                        verse_hider(el4, 'inline');
                        ticker = 40;
                        ticker2 = ticker2 - 40;
                        checker = 5;
                        break;
                    ...
                    case 9:
                        ...
                        break;
                    case 10:
                        memory_title.textContent = "KJV Bible Memory: CYCLE " + cycle_count + ": Case 10";                   
                        console.log('case 10: 1st');
                        verse_hider(el1, 'none');
                        verse_hider(el2, 'inline');
                        verse_hider(el3, 'none');
                        verse_hider(el4, 'none');
                        ...
                        break;
                    case 11:
                        memory_title.textContent = "KJV Bible Memory: CYCLE " + cycle_count + ": Case 11";                   
                        console.log('case 11: misc');
                        verse_hider(el1, 'none');
                        verse_hider(el2, 'none');
                        verse_hider(el3, 'none');
                        verse_hider(el4, 'inline');
                        ...
                        break;
                    case 12:
                        memory_title.textContent = "KJV Bible Memory: CYCLE " + cycle_count + ": Case 12";                   
                        console.log('case 12: full misc');
                        verse_hider(el1, 'inline');
                        verse_hider(el2, 'none');
                        verse_hider(el3, 'none');
                        verse_hider(el4, 'inline');
                        ...
                        break;
                    case 13:
                        memory_title.textContent = "KJV Bible Memory: CYCLE " + cycle_count + ": Case 13";                   
                        console.log('case 13: 1st misc');
                        verse_hider(el1, 'none');
                        verse_hider(el2, 'inline');
                        verse_hider(el3, 'none');
                        verse_hider(el4, 'inline');
                        ...
                        break;
                    case 14:
                        memory_title.textContent = "KJV Bible Memory: CYCLE " + cycle_count + ": Case 14";                   
                        console.log('case 14: blank misc');
                        if(ticker2 > 0) {
                            verse_hider(el1, 'none');
                            verse_hider(el2, 'none');
                            verse_hider(el3, 'inline');
        ...
        let el4 = document.getElementsByClassName('misc_verse_div');
        ...
        switch(e.target.className) {
            ...
            case 'blank_verse_div':
                ...
                break; 
            case 'misc_verse_div':
                console.log('misc manual content..');
                verse_hider(el1, 'inline');
                verse_hider(el2, 'none');
                verse_hider(el3, 'none'); 
                verse_hider(el4, 'none'); 
...
function toggleModal(e) {
    ...
    // Close button for displayed modal(either ABOUT or HELP)
        ...
        //e.stopPropagation();
        modal.classList.toggle("show-modal"); 
        console.log("close modal by close button");
...
function verse_parser6(elem, elem2, elem3, elem4, name, i) {
    let s = elem.split(' ');
    let data = "<div class='" + i + "'><a href='#' class='dynamic-a'><h3>" + name + " " + s[0] + "</h3></a><br></br><div class='full_verse_div'>" + elem + "</div><hr class='rounded'><div class='first_letter_verse_div'>" + elem2 + "</div><hr class='rounded'><div class='blank_verse_div'>" + elem3 + "</div><hr class='rounded'><div class='misc_verse_div'>" + elem4 + "</div></div>";
    return data;
}

// Used to create Normal verse divs
function verse_parser5(elem, elem2, elem3, elem4, name, i, chapter) {
    ...
    let data ="";
    let temp = []; // declare temp array to hold data variable and s2 variable

    if(s2[0] == chapter) {
         data = "<div class='dynamic-div' id='" + (i + 1) +  "'><a href='#' class='dynamic-a'><h3>" + name + " " + s[0] + "</h3></a><div class='full_verse_div'>" + elem + "</div><div class='first_letter_verse_div'>" + elem2 + "</div><div class='blank_verse_div'>" + elem3 + "</div><div class='misc_verse_div'>" + elem4 + "</div></div>";
        ...
        if(chapter_name == "" && chapter == "0") {
           // let data = "<section class='chapter-div'><p id='cc" + s2[0] +  "'>" + chapter_name + "</p></section><div class='dynamic-div' id=" + (i+1) +  "><a href='#' class='dynamic-a'><h3>" + name + " " + s[0] + "</h3></a><div class='full_verse_div'>" + elem + "</div><div class='first_letter_verse_div'>" + elem2 + "</div><div class='blank_verse_div'>" + elem3 + "</div></div>"; 
            data = "<p class='chapter-div' id='cc" + s2[0] +  "'>" + chapter_name + "</p><div class='dynamic-div' id=" + (i+1) +  "><a href='#' class='dynamic-a'><h3>" + name + " " + s[0] + "</h3></a><div class='full_verse_div'>" + elem + "</div><div class='first_letter_verse_div'>" + elem2 + "</div><div class='blank_verse_div'>" + elem3 + "</div><div class='misc_verse_div'>" + elem4 + "</div></div>"; 
        } 
        else if(chapter == "0") {
           // let data = "<section class='chapter-div'><p id='cc" + s2[0] +  "'>" + chapter_name + " " + s2[0] + "</p></section><div class='dynamic-div' id='" + (i+1) +  "'><a href='#' class='dynamic-a'><h3>" + name + " " + s[0] + "</h3></a><div class='full_verse_div'>" + elem + "</div><div class='first_letter_verse_div'>" + elem2 + "</div><div class='blank_verse_div'>" + elem3 + "</div></div>";
            data = "<p class='chapter-div' id='cc" + s2[0] +  "'>" + chapter_name + " " + s2[0] + "</p><div class='dynamic-div' id='" + (i+1) +  "'><a href='#' class='dynamic-a'><h3>" + name + " " + s[0] + "</h3></a><div class='full_verse_div'>" + elem + "</div><div class='first_letter_verse_div'>" + elem2 + "</div><div class='blank_verse_div'>" + elem3 + "</div><div class='misc_verse_div'>" + elem4 + "</div></div>";
        } else {
            data = "<br></br><br></br><p class='chapter-div' id='cc" + s2[0] + "'>" + chapter_name + " " + s2[0] + "</p><div class='dynamic-div' id='" + (i+1) +  "'><a href='#' class='dynamic-a'><h3>" + name + " " + s[0] + "</h3></a><div class='full_verse_div'>" + elem + "</div><div class='first_letter_verse_div'>" + elem2 + "</div><div class='blank_verse_div'>" + elem3 + "</div><div class='misc_verse_div'>" + elem4 + "</div></div>";
        }
        temp = [data, s2[0]]; // add value to temp
    }
